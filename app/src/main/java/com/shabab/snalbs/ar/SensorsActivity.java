...
public class SensorsActivity extends EasyLocationAppCompatActivity implements SensorEventListener, LocationListener {
    ...
    public void onLocationReceived(Location location) {
        Toast.makeText(this,"start,"+location.getLatitude(),Toast.LENGTH_LONG).show();
