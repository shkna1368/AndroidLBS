...
import com.shabab.snalbs.ActivityRadious;
 ...
 */
public class GetNearestByRadiousPlaceService {
    ActivityRadious context;
    ...
    public GetNearestByRadiousPlaceService(ActivityRadious ctx, RecyclerView recyclerView) {
        this.context = ctx;
        this. recyclerView=recyclerView;

    }

    public   void sendToServer(double lat,double lon,double radious) throws JSONException, UnsupportedEncodingException {
      ...
      //  String   urlGetCategory= Services.getCategories+shopId+'/'+password;
       ...
       final  String   urlNearest ="http://192.168.1.2:9090/v1/SnaLBS/findNearestPlaceByRadious/"+lat+"/"+lon+"/"+radious;
